...
class gradients(SyntheticInput):  # the class name should be the same as the filename, like in Java  # type: ignore
    ...
    def next_frame(self) -> tuple[np.ndarray | None, float]:  # type: ignore
        ...
        self.pix_arr = self.im_function(self.y[:, None], self.x[None, :], time)  # type: ignore
    ...
    def im_function(self, y, x, t):  # type: ignore
