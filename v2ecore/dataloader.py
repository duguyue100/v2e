...
class Frames(data.Dataset[Any]):
    ...
    def __init__(self, array: Any, transform: Optional[Callable[..., Any]] = None) -> None:
        """
        @Parameters:
            array: N-d numpy array.
            transform: Compose object.
...
class FramesDirectory(data.Dataset[Any]):
    ...
    def __init__(self, folder_path: str, ori_dim: Tuple[int, int], parsing: str = "/*.npy", transform: Optional[Callable[..., Any]] = None) -> None:
        """
        @Parameters:
            array: N-d numpy array.
            transform: Compose object.
